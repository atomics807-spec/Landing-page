  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:
          'border-2 border-primary-600 bg-transparent hover:bg-primary-50 text-primary-600 dark:hover:bg-primary-900/20',
        secondary:
          'bg-secondary-500 text-accent-blue hover:bg-secondary-600 shadow-sm',
        ghost:
          'hover:bg-primary-100 text-primary-600 dark:hover:bg-primary-900/20',
        link:
